...
```{r trace}
plot(seq(500), THETAna[,2], type = "l")
acf(THETAna,lag.max=50)

plot(seq(500), THETAeu[,2], type = "l")
acf(THETAeu,lag.max=50)

plot(seq(500), THETAas[,2], type = "l")
acf(THETAas,lag.max=50)

plot(seq(500), THETAoc[,2], type = "l")
acf(THETAoc,lag.max=50)

plot(seq(500), THETAaf[,2], type = "l")
acf(THETAaf,lag.max=50)

plot(seq(500), THETAsa[,2], type = "l")
